...
export default function FAQPage() {
    ...
    // 🔥 FUNCIÓN NUEVA: Abre el chat de Tawk.to al hacer clic
    ...
    // El sistema buscará 'cat1'...'cat6', 'q1'...'q6' y 'a1'...'a6' en tus archivos JSON.
    // Si falta alguno en el JSON, verás la clave (ej: FAQPage.q4) hasta que lo agregues.
    const faqs: FAQItem[] = [
        {
            category: t('cat1'), 
            question: t('q1'),
        ...
        <div className="min-h-screen bg-gray-50 font-montserrat">
                ...
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6">
                        ...
                        <span className="text-xs font-bold tracking-wider text-gray-200 uppercase">
                            {/* Usa traducción para el badge o fallback genérico */}
            ...
            <div className="max-w-4xl mx-auto px-4 -mt-16 relative z-20 pb-20">
                ...
                <div className="mt-12 bg-white rounded-3xl p-8 border border-dashed border-gray-300 flex flex-col md:flex-row items-center gap-6">
                    ...
                    {/* 👇 AQUÍ ESTÁ EL CAMBIO: Se agregó el evento onClick */}
                    <button 
