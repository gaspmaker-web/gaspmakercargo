...
export default function ServicesPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-montserrat">
            ...
            {/* HERO SECTION MEJORADO (Diseño Profesional) */}
            <div className="relative bg-[#1a1f2e] text-white pt-24 pb-32 px-4 overflow-hidden">
                ...
                {/* Patrón de puntos (opcional para textura) */}
            ...
            {/* SERVICES GRID (Superpuesto al header para efecto moderno) */}
