...
const HIDDEN = ['/dashboard', '/admin', '/driver', '/warehouse'];
export default function WhatsAppButton() {
  const pathname = usePathname();
  if (HIDDEN.some(p => pathname.includes(p))) return null;
  return (
    <a href="https://wa.me/17868346173" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:scale-110 transition-transform duration-200" aria-label="WhatsApp">
