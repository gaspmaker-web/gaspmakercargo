      ...
      <div className="min-h-screen bg-white flex flex-col font-sans">
        ...
        <div className="flex justify-between items-center px-5 pt-10 pb-2">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-[#222b3c] flex items-center justify-center text-[#F4DBA7] text-sm font-bold">
              {initials}
            </div>
        ...
        <div className="px-5 mb-3">
          <div className="flex items-center gap-1.5 text-sm text-gray-500">
            <MapPin size={14} className="text-[#F4DBA7]" style={{ color: '#b8993e' }} />
        ...
        <div className="flex items-center justify-around px-4 py-4 border-t border-gray-100">
          {[
            ...
            <button key={label} className="flex flex-col items-center gap-1">
              <Icon size={22} className={active ? 'text-[#222b3c]' : 'text-gray-400'} />
              <span className={`text-[10px] font-medium ${active ? 'text-[#222b3c]' : 'text-gray-400'}`}>{label}</span>
            </button>
          ))}
        </div>
      </div>
