...
export default async function DashboardPage({ params: { locale } }: Props) {
  ...
  console.log("DEBUG defaultAddress:", JSON.stringify(defaultAddress));
  const isUSClient = 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <ClientDashboard
                user={{...(session.user as any), countryCode: (defaultAddress?.countryCode || defaultAddress?.country || (dbUser as any)?.countryCode || '').toUpperCase() || undefined, isUSClient}}
