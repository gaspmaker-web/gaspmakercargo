...
export default function AboutPage() {
    ...
    // Configuración de las estadísticas con los nuevos datos
    const stats = [
        { 
            label: t('labelSatisfaction'), // "CLIENTES SATISFECHOS"
            value: t('statSatisfaction'),  // "99%"
            Icon: Users 
        },
        { 
            label: t('labelReliability'),  // "CONFIABILIDAD"
            value: t('statReliability'),   // "100%"
            Icon: ShieldCheck 
        },
        { 
            label: t('labelOnTime'),       // "ENTREGAS A TIEMPO"
            value: t('statOnTime'),        // "98%"
            Icon: Clock // Icono de reloj como solicitaste
        },
    ];
