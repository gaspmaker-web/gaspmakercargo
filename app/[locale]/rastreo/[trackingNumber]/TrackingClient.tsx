...
interface TrackingClientProps {
  pkg: any; // Recibimos el paquete ya procesado
  from?: string; // Para saber si volver al admin o al cliente
}

export default function TrackingClient({ pkg, from }: TrackingClientProps) {
