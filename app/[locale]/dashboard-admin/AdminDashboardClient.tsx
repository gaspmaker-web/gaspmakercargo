...
export default function AdminDashboardClient({ locale }: { locale: string }) {
  ...
  useEffect(() => {
    // Intentamos cargar stats, si falla no pasa nada (usamos ceros)
    fetch('/api/admin/stats')
      ...
      .catch(err => console.error("Error cargando stats (ignorable en build):", err))
        ...
        <div className="flex justify-between items-end border-b pb-4 border-gray-200">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              ...
              {/* ✅ CORRECCIÓN: Usamos 'as any' para evitar el error de TypeScript */}
