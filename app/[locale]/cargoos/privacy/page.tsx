      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-600 leading-relaxed">
            <p><strong className="text-gray-800">Operator Information:</strong> When a logistics company ("Operator") subscribes to CargoOS, we collect business name, contact information, billing details, and API credentials (EasyPost, Stripe) provided by the Operator.</p>
            <p><strong className="text-gray-800">End-User Information:</strong> Operators use CargoOS to manage their own customers ("End Users"). End User data — including names, addresses, shipping details, and payment information — is processed on behalf of the Operator.</p>
            <p><strong className="text-gray-800">Usage Data:</strong> We collect technical data such as IP addresses, browser type, pages visited, and actions taken within the platform to improve our service.</p>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">3. How We Use Information</h2>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong className="text-gray-800">EasyPost</strong> — shipping label generation and carrier rate quotes</li>
              <li><strong className="text-gray-800">Supabase</strong> — secure database hosting</li>
              <li><strong className="text-gray-800">Vercel</strong> — platform hosting and deployment</li>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">7. Operator Responsibilities</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">9. Your Rights</h2>
          <p className="text-gray-600 leading-relaxed">
            Depending on your location, you may have rights to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@cargoos.io" className="text-blue-600 hover:underline">hello@cargoos.io</a>.
          </p>
        </section>
