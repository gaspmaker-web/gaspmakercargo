...
import { MapPin, Phone, Clock, ExternalLink, Globe, Mail, User, Printer } from 'lucide-react';
    ...
    const offices = [
        {
            ...
            mapUrl: "https://maps.google.com/?cid=7685654538910362505&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ"
        },
        {
            ...
            mapUrl: "https://maps.google.com/?cid=18196042975728669684&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ"
        },
        {
            name: "Barbados (GCG Ground Services)",
            // Eliminados: Contacto personal, Fax, Celular, Email
            address: "GCG Ground Services Ltd, Barbados",
            phone: "+1 246 428 1670 (ext 3535)",
            hours: "Mon-Fri: 8:00 AM - 4:00 PM",
            mapUrl: "https://www.google.com/maps/search/?api=1&query=GCG+Ground+Services+Ltd+Barbados"
        },
        {
            ...
            mapUrl: "https://www.google.com/maps/search/?api=1&query=AJAS+Cargo+Norman+Manley+International+Airport"
        },
        {
            ...
            mapUrl: "https://www.google.com/maps/search/?api=1&query=Cyril+E.+King+Airport+St+Thomas"
        }
    ];
